...
const About = () => {
  return (
    <div className="border-b border-neutral-900 pb-4">
      <h1 className="my-20 text-center text-4xl glow-text">
        About 
      ...
      <div className="flex flex-wrap">
        ...
        >
          <div className="flex items-center justify-center">
            <img 
              className="mb-6 rounded glow-image" 
              src={aboutImg} 
              alt="about"
            />
          </div>
